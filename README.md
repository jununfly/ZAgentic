...
**Keeping the list in sync.** The list is generated by `scripts/list-skills.sh` (which scans `skills/` for `SKILL.md`). After you add or remove a skill, regenerate the list and commit the result:
