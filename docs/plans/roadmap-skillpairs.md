...
> 数据文件: `roadmap-skillpairs.json` | 最后更新: 2026-08-11 15:24:55
...
│   ├── [ ][X+] 1-4-5. wait-what (B独有): 评估移植
│   ├── [ ][X+] 1-4-6. to-questionnaire (B独有): 评估移植
...
推进中: 1-3 同源对 11/11 完成; 1-4 已处理 1-4-1/2/3。⚠️ 复查项: 1-3-10(setup)与 1-3-3(triage)在合并过程中完成, 须复查(尤其 PR flag 联动)。剩余 1-4: teach/wait-what/to-questionnaire/wizard 等。1-4-3 已翻转『不移植 Wayfinding』决定。
