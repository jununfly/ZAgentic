...
- **`/zj-research-report`** — turn `zj-research` findings into a cited decision draft. Technical comparisons compile through the sealed ledger and Report IR; general research keeps the same six-section report directly in Markdown.
